package es.hitoindividualadt2marioluquero.control;



import es.hitoindividualadt2marioluquero.jpa.Role;
import es.hitoindividualadt2marioluquero.jpa.Tarea;
import es.hitoindividualadt2marioluquero.jpa.Usuario;
import es.hitoindividualadt2marioluquero.servicios.RoleService;
import es.hitoindividualadt2marioluquero.servicios.TareaService;
import es.hitoindividualadt2marioluquero.servicios.UsuarioService;
...
public class Controlador {
    ...
    @RequestMapping("/user")
    public ModelAndView peticionUser(Authentication aut) {
        ModelAndView mv = new ModelAndView();
        if (aut == null)
            mv.addObject("user", "No se ha iniciado sesión");
        else
